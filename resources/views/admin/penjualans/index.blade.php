...
<div class="container px-4">
    <div class="max-w-full bg-white overflow-x-auto">
         ...
         <nav class="mb-6 flex items-center text-sm text-gray-600 space-x-2">
            ...
            <span>/</span>
            <a href="{{ route('admin.penjualans.index') }}" class="text-blue-600 hover:underline hover:text-blue-800">
                Penjualan
            </a>
        </nav>
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            ...
            <div class="flex justify-end gap-2 pb-4">
                <a href="{{ route('admin.penjualans.export') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                    ...
                    @foreach ($penjualans as $penjualan)
                        <tr>
                            ...
                            <td class="flex gap-2 justify-center">
                                ...
                                <form action="{{ route('admin.penjualans.pdf', $penjualan->id) }}" method="GET" target="_blank">
